    ...
    <div class="flex border" id="Campode_formularios">
        ...
        <div id="Cliente" class="campoFomr flex flexColumn">
            ...
            <div id="formCliente" class="hidden marginTop">
                ...
                <input type="hidden" id="id_clienteSearch" name="id_clienteSearch" value = "">
                <div id="search">
                    <div class="md-form mt-0">
                        <label for="NomeClientes"></label>
                        <input value='{{$clientes[0]->Nome}}' class="inputCustom" id="NomeClientes" {{--name="NomeClientes"--}} list='clientes' type="search" placeholder="Pesquisar cliente" aria-label="Search">
