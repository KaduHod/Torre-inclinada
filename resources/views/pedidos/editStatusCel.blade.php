...
<div class="ContainerComPaddingPadrao" >
    <h1 class="TituloPadraoConfig">Mudar status do pedido</h1>
    <div class="borderRadius BCbranco" id="editPedidoContainer" style="overflow: hidden">
        <div id="infoPedido">
            ...
            <li><span>Contato</span>: {{$pedido->cliente->Cel}}</li>
            @if($pedido->funcionario_id)
                <li><span>Funcionário responsável</span>: {{$pedido->funcionario_id}}</li>
            @else
                <li><span>Funcionário responsável</span>: Sem funcionário</li>
            @endif
